  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        <Image
          source={{ uri: 'https://snack-code-uploads.s3.us-west-1.amazonaws.com/~asset/7df09d3ef52ada6335d2f7863fb63a02' }} //
  ...
  <View style={styles.navigationButtons}>
    ...
    <TouchableOpacity onPress={() => navigation.navigate('Landscaping')}>
      ...
      <View style={styles.infoBox}>
        ...
        <Text style={styles.infoText}>To provide skills to navigate basic life necessities.</Text>
      </View>

      <View style={styles.infoBox}>
        <Text style={styles.infoTitle}>Content:</Text>
        <Text style={styles.infoText}>• Opening a Bank account</Text>
        <Text style={styles.infoText}>• Basic labour law (Know you writes)</Text>
        <Text style={styles.infoText}>• Basic reading and writing literacy</Text>
        <Text style={styles.infoText}>• Basic numeric literacy</Text>
      </View>
