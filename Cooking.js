  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        <Image
          source={{ uri: 'https://snack-code-uploads.s3.us-west-1.amazonaws.com/~asset/9d37b0ea9af346b92a5ede87d597d5c2' }} // 
      ...
      <View style={styles.infoBox}>
        ...
        <Text style={styles.infoText}>To prepare and cook nutritious family meals.</Text>
      </View>

      <View style={styles.infoBox}>
        <Text style={styles.infoTitle}>Content:</Text>
        <Text style={styles.infoText}>• Nutritional requirements for a healthy body</Text>
        <Text style={styles.infoText}>• Types of protein, carbohydrates and vegetables</Text>
        <Text style={styles.infoText}>• Planning meals</Text>
        <Text style={styles.infoText}>• Preparation and cooking of meals</Text>
      </View>
