  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        <Image
          source={{ uri: 'https://snack-code-uploads.s3.us-west-1.amazonaws.com/~asset/9a1bffabc21a2237e8705b7e2d5cfb62' }} 
      ...
      <View style={styles.infoBox}>
        ...
        <Text style={styles.infoText}>To provide basic knowledge of watering, pruning and planting in a domestic garden.</Text>
      </View>

      <View style={styles.infoBox}>
        <Text style={styles.infoTitle}>Content:</Text>
        <Text style={styles.infoText}>• Water restrictions & the watering requirements of indigenous & exotic plants</Text>
        <Text style={styles.infoText}>• Pruning and propagation of plants</Text>
        <Text style={styles.infoText}>• Planting techniques for different plant types</Text>
      </View>
