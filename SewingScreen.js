    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.header}>
        <TouchableOpacity onPress={() => navigation.navigate('Home')}>
          <Image
            source={{ uri: 'https://snack-code-uploads.s3.us-west-1.amazonaws.com/~asset/19535cd7343f67810d90082181456b9b' }} // Replace with your header icon/image URL
      ...
      <View style={styles.imageContainer}>
        <Image
          source={{ uri: 'https://snack-code-uploads.s3.us-west-1.amazonaws.com/~asset/a1806bd42b3c1125827eebca678caaed' }} // Replace this URI with your course image URL
  ...
  <View style={styles.navigationButtons}>
    ...
    <TouchableOpacity onPress={() => navigation.navigate('LifeSkills')}>
      ...
      <View style={styles.infoBox}>
        ...
        <Text style={styles.infoText}>To provide alterations and new garment tailoring services</Text>
      </View>

      <View style={styles.infoBox}>
        <Text style={styles.infoTitle}>Content:</Text>
        <Text style={styles.infoText}>• Types of stitches</Text>
        <Text style={styles.infoText}>• Threading a sewing machine</Text>
        <Text style={styles.infoText}>• Sewing buttons, zips, hems, and seams</Text>
        <Text style={styles.infoText}>• Alterations</Text>
        <Text style={styles.infoText}>• Designing and sewing new garments</Text>
      </View>
